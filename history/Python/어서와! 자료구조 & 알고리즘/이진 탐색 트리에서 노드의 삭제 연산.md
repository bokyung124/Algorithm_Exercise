...
def remove(self, key):
        ...
        if node:
            ...
            # When the node has both left and right children
                ...
                successor, parent = successor.lookup(successor)
...
- 우선 이진 탐색 트리에서 노드를 삭제할 때의 경우의 수를 다 생각할 줄 알아야 한다!
- 자식이 부모의 왼쪽 노드인지, 오른쪽 노드인지 판단할 때
    - if문 대신 부모의 키와 자식의 키를 비교하는 방법 사용하기 !!